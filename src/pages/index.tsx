  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Empowering employers to manage employee data, vacations, and payroll seamlessly for maximum business efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Empowering employers to manage employee data, vacations, and payroll seamlessly for maximum business efficiency.`}
            </Text>
            <Box
